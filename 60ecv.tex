...
Each value $c_{i}$ represents a log-ratio between $k$ and $l$.
...
This means determining the probability of the log-ratio $k/l$ between the items $k$ and $l$ as being in the range of $\frac{3}{4}$ to $\frac{4}{3}$.
Or in terms of log-ratios it means determining the probability of $ilr(l, m)$ being between $ilr(3,4)$ and $ilr(4,3)$, where l is value from column k and m is value from column l.
...
\caption{
	...
	Cumulative distribution function of the log-ratio $l/m$ between the items $l$ and $m$ (area $p$ denotes probability that $l/m$ is between $\frac{3}{4}$ and $\frac{4}{3}$.)
}
\end{figure}
