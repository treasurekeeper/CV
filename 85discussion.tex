...
%kri: answer to question below, imho:
...
%rto: Once again, we have no idea what extra value we provide with ECV compared how they've done it before?!?
%kri: see above
...
The systematic review conducted as a part of this study revealed that 22 studies analyze CV results; yet, only one study uses compositional data analysis methods, i.e.\ \citep{Chatzipetrou2010}.%rto: and how does our approach differ from Chatzipetrou's et al.? There is a very large probability that Lefteris Anglelis (one of the co-authors) will review this paper and he is good in statistics...
%kri:
