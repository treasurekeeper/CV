...
%rto: yes, this is the summary, but where are all the calculations and how does ECV compare to the results from the papers?
%kri: What calculations? The results in the table are the output of the R program. Do you mean the steps of the ECV?

%rto: We need to show that we provide an added benefit or that we are plainly speaking "better" in some sense.
%kri: see added value for each study below and also in Section Discussion
...
%kri added value of ECV:
If the system is developed in several releases Assignment Submission and Assignment Feedback features can be freely interchanged between the releases.
This way ECV simplifies release planning.
...
%kri added value of ECV: did not have any good idea for this
