...
\subsubsection{Is it the Right Study?}
...
% Some items in the checklist are intended to be used only for appraisal of experiments, others cannot be used for experiments. It can be seen that there are more items that are applicable only to experiment. Hence, it is more likely for an experimental study to receive higher rating of correctness of research process. But it is acceptable because experiment in general is most rigorous and advanced type of study.
